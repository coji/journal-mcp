  ...
  return (
    <Layout>
      <div className="space-y-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Recent Journal Entries</h1>
        ...
        {recentEntries.length === 0 ? (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
            ...
            <p className="text-gray-600 mb-4">
              Start writing your first journal entry using Claude Desktop with the journal MCP server.
            </p>
            <div className="bg-gray-50 rounded-lg p-4 text-left max-w-md mx-auto">
              <p className="text-sm text-gray-700 font-medium mb-2">Try asking Claude:</p>
