...
export async function loader({ request }: Route.LoaderArgs) {
  ...
  const searchParams = {
    ...
    tags: url.searchParams.get("tags")?.split(",").map(t => t.trim()).filter(Boolean) || undefined,
  ...
  return (
    <Layout>
      <div className="space-y-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Search Journal Entries</h1>
